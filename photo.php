...
<!------------------------------------------------Photo Gallery------------------------------------------------------->
<div class="container text-center"><h2>Photo Gallery</h2></div>
...
if($num > 0){
  while($image = mysqli_fetch_array($queryfire)){
    ?>

  <!-- card- -->
        <div class="col">
            <div class="card shadow-sm">
            <img src="admin/images/<?php echo $image['photo']?>" width='100%' height='225'   alt="images" class="img-fluid mb-2"> 
                <div class="card-body text-center" >
                <h4>Image Discription</h4> 
                <?php echo $image['dis'];?>
