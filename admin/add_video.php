...
if (isset($_POST['submit'])) {
	...
	$video_id = $_POST["video_id"];
        ...
        $q = "INSERT INTO `video`(`video_id`, `dis`) VALUES ('$video_id','$dis')";
...
if($sweetAlert){
     ...
     <strong>Well done! </strong>video added successfully.
     </div
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Video Id</label>
<div class="col-sm-10">
<input type="text"  class="form-control" id="video_id" name="video_id"  required="required" autocomplete="off">
<h6><b>NOTE:-</b></h6>
<p>Plz. don't post video link direcly. <B>Video id </B> is written in the end of link.</p>
<p> <i><b>https://youtu.be/xocNf8dI2eA</i></b> In this link video Id is <i><b>xocNf8dI2eA</b></i></p>
